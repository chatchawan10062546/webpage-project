...
const oldSearch = `                <!-- ค้นหาและกรอง -->
                <div class="row gx-2 mb-4 mt-2">
                    ...
                    <div class="col-md-3">
                        <!-- ปุ่มอัปเดตตำแหน่ง ย้ายมาข้างๆ ช่องค้นหา -->
                        <button class="btn btn-outline-success btn-lg w-100 shadow-sm" id="updateLocationBtn">
                            <i class="bi bi-geo-alt-fill me-1"></i>อัปเดตพิกัด
                        </button>
                    </div>
                </div>`;
